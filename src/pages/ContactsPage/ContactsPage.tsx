    ...
    return (
        <div className="w-full">
            ...
            <div className="px-4 md:px-10 pt-[60px] md:pt-[60px]">
                <h1 className="text-[28px] md:text-[36px] leading-[32px] md:leading-[36px] font-medium uppercase mb-[80px] md:mb-[128px]">
                    Связаться с нами
                </h1>
            </div>
            ...
            <div className="px-4 md:px-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-[40px] gap-x-[40px] lg:gap-x-0">
                    ...
                    <div className="lg:w-[465px]">
                        <h2 className="text-[16px] font-medium uppercase leading-[16px] mb-[32px] md:mb-[48px]">
                            В мессенджерах
                        </h2>
                        <div className="space-y-1">
                            <a
                                ...
                                className="block text-[16px] leading-[20px] text-[#565656] hover:text-black dark:hover:text-white transition-colors"
                            >
                                Whats App
                            </a>
                            <a
                    ...
                    <div className="lg:w-[310px]">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-[16px] leading-[20px] text-[#565656]">
                                Бесплатно по России
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="lg:flex-1">
                        ...
                        <p className="text-[16px] leading-[20px] text-[#565656] max-w-[288px]">
