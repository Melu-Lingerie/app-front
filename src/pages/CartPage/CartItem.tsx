...
export const CartItem = ({
    ...
    return (
        <div className="relative border-t border-[#CCC] dark:border-white/10 pt-6 w-full">
            ...
            <div
                className={`flex gap-6 w-full transition-opacity duration-300 ${
            ...
            >
                ...
                <div className="flex-1 flex flex-col justify-between w-full">
                    ...
                    <div className="mt-[15px] flex items-center justify-between w-full">
                        <h2
                            className="truncate text-[16px] font-normal leading-[22px] max-w-[200px]"
                        ...
                        <div className="flex items-center gap-[62px] ml-auto">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="w-6 text-center text-[#999] font-normal leading-[22px]">
                                    {item.quantity}
                                </span>
                                <button
