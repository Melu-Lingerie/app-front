...
export const CustomersPage = () => {
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row md:min-h-180">
                {/* Левая колонка с табами (на мобильном - горизонтальные табы сверху) */}
                <div className="w-full md:w-1/4 md:border-r border-b md:border-b-0 border-[#CCCCCC] dark:border-white/10 pt-6 md:pt-[68px]">
                    <div className="px-4 md:pl-[40px] md:pr-0 mb-4 md:mb-[100px] text-[20px] md:text-[24px] leading-[22px] md:leading-[26px] font-medium uppercase">
                        Покупателям
                    </div>
                    ...
                    <nav className="overflow-x-auto md:overflow-x-visible">
                        ...
                        <div className="flex md:flex-col whitespace-nowrap md:whitespace-normal">
                            {tabs.map((tab) => {
                                const isActive = location.pathname === tab.path;
                                return (
                                    <div key={tab.path} className="flex-shrink-0 md:flex-shrink md:block">
                                        <button
                                            onClick={() => handleTabClick(tab.path)}
                                            className={`h-[44px] md:h-[56px] flex items-center px-4 md:px-0 md:pl-[40px] md:w-full text-left text-[14px] md:text-[16px] leading-[16px] md:leading-[18px] uppercase transition-colors ${
                                                isActive
                                                    ? 'bg-[#F8C6D7]'
                                                    : 'hover:bg-[#F8C6D7]/40'
                                            }`}
                                ...
                                element={
                                    ...
                                    >
                                        <div className="space-y-8 md:space-y-[60px]">
                                            {/* 1. Экспресс-доставка */}
                                            <section>
                                                <h2 className="text-[14px] md:text-[16px] leading-[16px] md:leading-[18px] font-medium uppercase mb-3">
                                                    Экспресс-доставка
                                                </h2>
                                                <p className="text-[14px] md:text-[16px] leading-[20px] md:leading-[22px] mb-3">
                                                    По Москве и Санкт-Петербургу доступна доставка день в день или на следующий.
                                                </p>
                                                <p className="text-[14px] md:text-[16px] leading-[20px] md:leading-[22px] mb-2">
                                                    Детали экспресс‒доставки:
                                                </p>
                                                <ul className="text-[14px] md:text-[16px] leading-[20px] md:leading-[22px] list-disc pl-5 space-y-1">
                                                    <li>
                                            ...
                                            <section>
                                                <h2 className="font-medium text-[14px] md:text-[16px] leading-[16px] md:leading-[18px] uppercase mb-3">
                                                    Как получить заказ?
                                                </h2>
                                                <p className="text-[14px] md:text-[16px] leading-[20px] md:leading-[22px] mb-3">
                                    ...
                                    >
                                        <div className="space-y-8 md:space-y-[60px]">
                                            <section>
                                                ...
                                                <ul className="text-[14px] md:text-[16px] leading-[20px] md:leading-[22px] list-disc pl-5 space-y-1 mb-2">
                                                    <li>
                                            ...
                                            <section>
                                                ...
                                                <ol className="text-[14px] md:text-[16px] leading-[20px] md:leading-[22px] list-decimal pl-5 space-y-1 mb-2">
                                                    <li>
                                ...
                                element={
                                    ...
                                    >
                                        <div className="space-y-6 md:space-y-[40px]">
                                            <section>
                                                <p className="text-[14px] md:text-[16px] leading-[16px] md:leading-[18px] font-medium uppercase mb-3">
