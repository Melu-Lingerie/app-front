...
export const ActualInfo = () => {
    ...
    if (loading) {
        return (
            <div className="w-full h-[calc(100svh-50px)] relative bg-gray-200 animate-pulse flex flex-col items-center justify-end">
    ...
    return (
        <div
            className="relative w-full h-[calc(100svh-50px)] overflow-hidden touch-pan-y"
